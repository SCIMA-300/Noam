...
void setup()
{
  ...
  //String data = wc.fromTextFile("uber_2015-11-5-21-21-20.txt"); //DOESNT WORK

  //String[] stopWords = { "I", "am", "a", "t", "co", "http" };
  String[] stopWords = loadStrings("StopWords.txt");
  //println(stopWords);
  String[] data = loadStrings("uber_2015-11-5-21-21-20.txt");
